...
public class Modelblack_chui_armor<T extends Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("chineseweapons", "modelblack_chui_armor"), "main");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition bipedBody = partdefinition.addOrReplaceChild("bipedBody", CubeListBuilder.create().texOffs(0, 17).addBox(-4.0F, -0.5F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(1.0F))
                .texOffs(32, 0).addBox(-4.5F, -0.5F, -2.0F, 9.0F, 7.0F, 4.0F, new CubeDeformation(1.1F)), PartPose.offset(0.0F, 0.0F, 0.0F));
