...
public class Modelmountain_character_armor<T extends Entity> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChineseweaponsMod.MODID, "modelmountain_character_armor"), "main");
