...
public abstract class IronmiddletangdynastymingguangarmorItem extends ArmorItem implements DyeableItem {
	public IronmiddletangdynastymingguangarmorItem(ArmorItem.Type type, Item.Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("ironmiddletangdynastymingguangarmor", new int[]{3, 6, 7, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON, Items.IRON_INGOT, 0f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 16));
	}

    public static final String TEXTURE_BASE = "chineseweapons:textures/entities/iron_middle_tang_dynasty_ming_guang_armor.png";
	...
	public static class Helmet extends IronmiddletangdynastymingguangarmorItem {
		public Helmet() {
	...
	public static class Chestplate extends IronmiddletangdynastymingguangarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends IronmiddletangdynastymingguangarmorItem {
		public Leggings() {
	...
	public static class Boots extends IronmiddletangdynastymingguangarmorItem {
		public Boots() {
