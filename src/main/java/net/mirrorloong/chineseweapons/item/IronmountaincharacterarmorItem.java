...
public abstract class IronmountaincharacterarmorItem extends ArmorItem implements DyeableItem {
	public IronmountaincharacterarmorItem(ArmorItem.Type type, Item.Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("ironmountaincharacterarmor", new int[]{3, 6, 7, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON, Items.IRON_INGOT, 0f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 16));
	}

    public static final String TEXTURE_BASE = "chineseweapons:textures/entities/iron_mountain_character_armor.png";
    ...
    public static class Helmet extends IronmountaincharacterarmorItem {
		public Helmet() {
	...
	public static class Chestplate extends IronmountaincharacterarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends IronmountaincharacterarmorItem {
		public Leggings() {
	...
	public static class Boots extends IronmountaincharacterarmorItem {
		public Boots() {
