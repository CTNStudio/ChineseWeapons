...
public abstract class NetheritemountaincharacterarmorItem extends ArmorItem {
	public NetheritemountaincharacterarmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public String getName() {
				return "netheritemountaincharacterarmor";
			}
	...
	public static class Helmet extends NetheritemountaincharacterarmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "chineseweapons:textures/entities/netherite_mountain_character_armor.png";
		}
	}
