...
public abstract class NetheritemiddletangdynastymingguangarmorItem extends ArmorItem implements DyeableItem {
	public NetheritemiddletangdynastymingguangarmorItem(ArmorItem.Type type, Item.Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("netheritemiddletangdynastymingguangarmor", new int[]{2, 7, 9, 4}, 16, SoundEvents.ARMOR_EQUIP_NETHERITE, Items.NETHERITE_INGOT, 3f, 0.1f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 38));
	}
	...
	public static class Chestplate extends NetheritemiddletangdynastymingguangarmorItem {
		public Chestplate() {
	...
	public static class Boots extends NetheritemiddletangdynastymingguangarmorItem {
		public Boots() {
