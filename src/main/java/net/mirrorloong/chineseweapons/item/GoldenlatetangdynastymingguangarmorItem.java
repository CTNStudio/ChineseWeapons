...
public abstract class GoldenlatetangdynastymingguangarmorItem extends ArmorItem implements DyeableItem {
	public GoldenlatetangdynastymingguangarmorItem(Type type, Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("goldenlatetangdynastymingguangarmor", new int[]{2, 4, 6, 3}, 26, SoundEvents.ARMOR_EQUIP_GOLD, Items.GOLD_INGOT, 1f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 15));
	}

    public static final String TEXTURE_BASE = "chineseweapons:textures/entities/golden_late_tang_dynasty_ming_guang_armor.png";
