...
public abstract class GoldenmountaincharacterarmorItem extends ArmorItem implements DyeableItem {
	public GoldenmountaincharacterarmorItem(ArmorItem.Type type, Item.Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("goldenmountaincharacterarmor", new int[]{2, 4, 6, 3}, 26, SoundEvents.ARMOR_EQUIP_GOLD, Items.GOLD_INGOT, 1f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 15));
	}
	...
	public static class Chestplate extends GoldenmountaincharacterarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends GoldenmountaincharacterarmorItem {
		public Leggings() {
	...
	public static class Boots extends GoldenmountaincharacterarmorItem {
		public Boots() {
