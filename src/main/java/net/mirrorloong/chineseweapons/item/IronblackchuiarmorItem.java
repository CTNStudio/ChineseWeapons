...
public abstract class IronblackchuiarmorItem extends ArmorItem {
	public IronblackchuiarmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(ChineseWeaponsArmorMaterials.holder("ironblackchuiarmor", new int[]{3, 6, 7, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON, Items.IRON_INGOT, 0f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 16));
	}
	...
	public static class Leggings extends IronblackchuiarmorItem {
		public Leggings() {
