...
public abstract class DiamondmountaincharacterarmorItem extends ArmorItem implements DyeableItem {
	public DiamondmountaincharacterarmorItem(ArmorItem.Type type, Item.Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("diamondmountaincharacterarmor", new int[]{2, 7, 9, 4}, 11, SoundEvents.ARMOR_EQUIP_DIAMOND, Items.DIAMOND, 2f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 34));
	}
