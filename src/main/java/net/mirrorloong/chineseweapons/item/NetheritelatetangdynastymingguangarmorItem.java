...
public abstract class NetheritelatetangdynastymingguangarmorItem extends ArmorItem implements DyeableItem {
	public NetheritelatetangdynastymingguangarmorItem(Type type, Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("netheritelatetangdynastymingguangarmor", new int[]{2, 7, 9, 4}, 16, SoundEvents.ARMOR_EQUIP_NETHERITE, Items.NETHERITE_INGOT, 3f, 0.1f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 38));
	}

    public static final String TEXTURE_BASE = "chineseweapons:textures/entities/netherite_late_tang_dynasty_ming_guang_armor.png";
    ...
    public static class Helmet extends NetheritelatetangdynastymingguangarmorItem {
		public Helmet() {
	...
	public static class Chestplate extends NetheritelatetangdynastymingguangarmorItem {
		public Chestplate() {
	...
	public static class Leggings extends NetheritelatetangdynastymingguangarmorItem {
		public Leggings() {
	...
	public static class Boots extends NetheritelatetangdynastymingguangarmorItem {
		public Boots() {
