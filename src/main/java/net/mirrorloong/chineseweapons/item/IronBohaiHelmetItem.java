...
public abstract class IronBohaiHelmetItem extends ArmorItem implements DyeableItem {
	public IronBohaiHelmetItem(Type type, Properties properties) {
				super(ChineseWeaponsArmorMaterials.holder("ironbohaihelmet", new int[]{3, 6, 7, 3}, 10, SoundEvents.ARMOR_EQUIP_IRON, Items.IRON_INGOT, 0f, 0f), type, properties.durability(new int[]{13, 15, 16, 11}[type.getSlot().getIndex()] * 16));
	}
